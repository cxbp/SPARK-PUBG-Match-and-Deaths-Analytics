...
Initial Plan:
Use this dataset to develop some useful suggestions for PUBG players to help them improve the placement in the game. 
...
c. Figure out the relationship between kill_distance and kill_by.\
